...
const Blogs = () => {
    return (
        <div className='grid lg:grid-cols-2 md:grid-cols-1 mb-4'>
            <div class="collapse w-96 mx-auto mt-6 rounded-md">
                <input type="checkbox" class="peer" />
                <div class="collapse-title bg-primary text-primary-content peer-checked:bg-neutral peer-checked:text-secondary-content">
            ...
            <div class="collapse w-96 mx-auto mt-4 rounded-md">
                <input type="checkbox" class="peer" />
                <div class="collapse-title bg-primary text-primary-content peer-checked:bg-neutral peer-checked:text-secondary-content">
