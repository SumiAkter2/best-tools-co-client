            ...
            <div class="hero min-h-screen bg-base-200 px-12">
                <div class="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className='text-left'>
                        <h1 class="text-5xl font-bold text-pink-400">Something About Us</h1>
                        <div class="divider "></div>
                        <p class="py-4">We provide best tools for our clients that they can benefited. the demand of users all over to have more access to content. Between driller, nuts, bolt, and  accessibility on the tools is so easy to use.</p>
